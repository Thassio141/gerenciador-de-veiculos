...
public class VeiculoRepository {
    ...
    public void salvarCarro(Carro carro) {
        String sql = "INSERT INTO veiculos (tipo, modelo, fabricante, ano, preco, quantidade_portas, tipo_combustivel) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public void salvarMoto(Moto moto) {
        String sql = "INSERT INTO veiculos (tipo, modelo, fabricante, ano, preco, cilindrada) "
                + "VALUES (?, ?, ?, ?, ?, ?)";
        jdbcTemplate.update(sql,
    ...
    public List<Veiculo> buscarPorFiltros(TipoVeiculo tipo, String modelo, Integer ano) {
    ...
    public void atualizarMoto(Moto moto) {
        String sql = "UPDATE veiculos SET "
                + "modelo = ?, fabricante = ?, ano = ?, preco = ?, cilindrada = ? "
                + "WHERE id = ?";
        jdbcTemplate.update(sql,
                moto.getModelo(),
                moto.getFabricante(),
